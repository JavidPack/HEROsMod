...
{
    class RegionService: HEROsModService
    {
        ...
        void bConfirm_onLeftClick(object sender, EventArgs e)
        {
        ...
        void bCreateRegion_onLeftClick(object sender, EventArgs e)
        {
    ...
    class RegionWindow : UIWindow 
    {
        ...
        void bSaveColor_onLeftClick(object sender, EventArgs e)
        {
        ...
        void colorSlider_valueChanged(object sender, float value)
        {
        ...
        void bToggleRegions_onLeftClick(object sender, EventArgs e)
        {
            RegionService.RegionsVisible = !RegionService.RegionsVisible;
        }

        void bDeleteRegion_onLeftClick(object sender, EventArgs e)
        {
            if(SelectedRegion == null)
            {
                PopulateRegionsList();
        ...
        void bBack_onLeftClick(object sender, EventArgs e)
        {
        ...
        void bEdit_onLeftClick(object sender, EventArgs e)
        {
        ...
        void RemovePlayer(object sender, EventArgs e)
        {
        ...
        void RemoveGroup(object sender, EventArgs e)
        {
            UIButton button = (UIButton)sender;
        ...
        void bRemoveAllRegions_onLeftClick(object sender, EventArgs e)
        {
            for(int i = 0; i < HEROsModNetwork.Network.Regions.Count; i++)
            {
    ...
    class SelectionConformationWindow : UIWindow
    {
    ...
    class NameRegionWindow : UIWindow
    {
        UILabel label = null;
    ...
    class PlayerGroupSelectionWindow : UIWindow
    {
        ...
        void userLabel_onLeftClick(object sender, EventArgs e)
        {
        ...
        void groupLabel_onLeftClick(object sender, EventArgs e)
        {
            UILabel label = (UILabel)sender;
