...
namespace HEROsMod.UIKit
{
    class UIScrollView : UIView
    {
        ...
        static Texture2D ScrollbgTexture = GetEmbeddedTexture("Images/UIKit/scrollbgEdge");
        static Texture2D scrollbgFill;
        ...
        bool dragging = false;
        Vector2 dragAnchor = Vector2.Zero;
        ...
        void scrollBar_onMouseDown(object sender, byte button)
        {
            if (button == 0)
            {
                dragging = true;
        ...
        void DrawScrollbg(SpriteBatch spriteBatch)
        {
