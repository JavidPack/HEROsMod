...
namespace HEROsMod.UIKit
{
    ...
    class UIView
    {
        ...
        */
        ...
        void DisplayTooltip(object sender, EventArgs e)
        {
        ...
        void view_onMouseUp(object sender, byte button)
        {
            mouseUpHandled = true;
        }

        void view_onMouseDown(object sender, byte button)
        {
